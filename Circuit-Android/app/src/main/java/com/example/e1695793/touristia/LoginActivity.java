    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                try {
                    URL url = new URL("https://touristia.000webhostapp.com/services/");
                    ...
                    if (statusCode == 200) {
                        ...
                        } else if (reponse == "nexiste") {

                        } else if (reponse == "incorrecte") {
        ...
        private void hideItem(int v) {
            NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view);
            Menu nav_Menu = navigationView.getMenu();
            nav_Menu.findItem(v).setVisible(false);
        }
        ...
        private void parseResult(String result) {
            try {
                ...
                for (int i = 0; i < posts.length(); i++) {
                    ...
                    reponse = post.optString("reponse");
